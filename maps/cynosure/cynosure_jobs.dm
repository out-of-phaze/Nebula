...
/datum/job/trained_animal/equip_preview(mob/living/human/H, var/alt_title, var/datum/preferences/prefs)
	if(!prefs)
...
/datum/job/trained_animal/handle_nonhuman_mob(var/mob/living/human/player, var/alt_title)
...
/obj/item/animal_harness/grafadreka/expedition
...
/obj/item/animal_harness/grafadreka/expedition/CreateAttachments()
	...
	new /obj/item/mre/menu13 (src) // The good stuff
...
Using <font color='#e0a000'>grab intent</font> you can pick up and drop items by clicking them or yourself, and can interact with some simple machines like buttons and levers."}
	harness = /obj/item/animal_harness/grafadreka/expedition
