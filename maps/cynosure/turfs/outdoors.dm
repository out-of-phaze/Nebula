...
/turf/floor/outdoors/mud
	oxygen		= MOLES_O2SIF
	nitrogen	= MOLES_N2SIF
	temperature	= TEMPERATURE_SIF

/turf/floor/outdoors/rocks
	oxygen		= MOLES_O2SIF
	nitrogen	= MOLES_N2SIF
	temperature	= TEMPERATURE_SIF
...
/// For non-specific maps that still need snow, you should use `/obj/abstract/landmark/snowy_turf` on top of other floors.
/turf/floor/outdoors/dirt/presnowed
	snow_layers = SNOW_HEAVY

/turf/floor/outdoors/grass
	oxygen		= MOLES_O2SIF
	nitrogen	= MOLES_N2SIF
	temperature	= TEMPERATURE_SIF

/turf/floor/outdoors/grass/sif/forest/planetuse
	oxygen		= MOLES_O2SIF
	nitrogen	= MOLES_N2SIF
	temperature	= TEMPERATURE_SIF

/turf/floor/outdoors/dirt
	oxygen		= MOLES_O2SIF
	nitrogen	= MOLES_N2SIF
	temperature	= TEMPERATURE_SIF
...
/turf/floor/natural/sif/mud
	name = "mud"
	icon_state = "mud"
	sand_icon_state = "mud"

/turf/floor/natural/sif/dirt
	name = "sand"
	icon_state = "dirt"
...
/turf/wall/natural/ignore_mapgen/vacuum
	oxygen = 0
	nitrogen = 0
	temperature = TCMB

/turf/floor/natural/vacuum
	oxygen = 0
	nitrogen = 0
	temperature = TCMB

/turf/floor/natural/ignore_mapgen/vacuum
	oxygen = 0
	nitrogen = 0
	temperature = TCMB
