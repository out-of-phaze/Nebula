...
/datum/job/homestead/local/miner
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/homestead/miner
	min_skill               = list(
...
/obj/abstract/landmark/start/homestead/miner
	name                    = "Miner"
...
/datum/job/homestead/local/herbalist
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/homestead/herbalist
	min_skill               = list(
...
/obj/abstract/landmark/start/homestead/herbalist
	name                    = "Herbalist"
...
/datum/job/homestead/local/forester
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/homestead/forester
	min_skill               = list(
...
/obj/abstract/landmark/start/homestead/forester
	name                    = "Forester"
