...
/datum/job/homestead/visitor/beggar_knight
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/homestead/beggar_knight
	min_skill               = list(
...
/obj/abstract/landmark/start/homestead/beggar_knight
	name                    = "Beggar Knight"
...
/datum/job/homestead/visitor/traveller/cleric
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/homestead/traveller/cleric
	min_skill               = list(
		SKILL_COMBAT        = SKILL_ADEPT,
		SKILL_WEAPONS       = SKILL_ADEPT,
		SKILL_ATHLETICS     = SKILL_ADEPT,
...
/obj/abstract/landmark/start/homestead/cleric
