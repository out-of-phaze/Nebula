/area/homestead/caves/entrance
	name = "\improper Surface Tunnels"
	color = COLOR_GRAY80

/area/homestead/caves/unexplored
...
/area/homestead/caves/unexplored/south
	name = "\improper Trackless Deeps - South"

/area/homestead/caves/river
	...
	area_blurb_category = /area/homestead/caves/river
	ambience = list(
		'sound/ambience/ominous1.ogg',
		'sound/ambience/ominous2.ogg',
		'sound/ambience/ominous3.ogg',
...
/area/homestead/outside/river
	...
	area_blurb_category = /area/homestead/outside/river
	forced_ambience = list('sound/ambience/shore.ogg')
	area_flags = parent_type::area_flags | AREA_FLAG_ALLOW_LEVEL_PERSISTENCE | AREA_FLAG_NO_LEGACY_PERSISTENCE

/area/homestead/outside/river/get_additional_fishing_results()
...
/area/homestead/caves
	...
	area_blurb_category = /area/homestead/caves
	sound_env = CAVE
