/datum/random_map/automata/cave_system/homestead
	descriptor          = "Homestead caves"
	floor_type          = /turf/floor/rock/basalt
	wall_type           = /turf/wall/natural/basalt/homestead
	sparse_mineral_turf = /turf/wall/natural/random/basalt/homestead
	rich_mineral_turf   = /turf/wall/natural/random/high_chance/basalt/homestead

/datum/random_map/noise/homestead
	abstract_type = /datum/random_map/noise/homestead
...
/datum/random_map/noise/homestead/swamp
	descriptor           = "Homestead swamp"

/datum/random_map/noise/homestead/swamp/get_appropriate_path(var/value)
...
/datum/random_map/noise/homestead/woods
	descriptor = "Homestead Woods"

/datum/random_map/noise/homestead/woods/get_appropriate_path(var/value)
	value = noise2value(value)
	if(value <= 6)
		return /turf/floor/grass/wild
	return /turf/floor/grass

/datum/random_map/noise/forage/homestead/grassland/New()
	forage["grass"] |= list(
		"yarrow",
		"valerian"
	)
...
/datum/random_map/noise/forage/homestead/swamp/New()
	forage["grass"] |= list(
		"aloe",
		"foxglove"
	)
...
/datum/random_map/noise/forage/homestead/woods/New()
	forage["grass"] |= list(
		"ginseng",
		"foxglove",
