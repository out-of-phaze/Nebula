SUBSYSTEM_DEF(mapping)
	...
	///This helps shuttles locate correct areas. Format: list(string map_hash = list(area_type = area_instance)). Autogenerated on template load.
	var/list/map_hash_to_areas = list()
