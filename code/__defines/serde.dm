...
#define SERIALIZE_DECL_LIST_ASSOC(V, T) if(islist(V)) { var/list/__decl_uids = list(); for(var/key in V) { var/decl/__decl = RESOLVE_TO_DECL(V[key]); __decl_uids += __decl.uid }; SERIALIZE_VALUE(V, T, __decl_uids) }
