...
/datum/shuttle/autodock/ferry
	...
	var/obj/effect/shuttle_landmark/waypoint_station as anything //This variable is type-abused initially: specify the landmark_tag, not the actual landmark.
	var/obj/effect/shuttle_landmark/waypoint_offsite as anything //This variable is type-abused initially: specify the landmark_tag, not the actual landmark.
