...
/decl/language/sign
	name = "Sign Language"
	desc = "In an age of commonplace extra-vehicular activity and habitation of airless worlds, sign language \
	is often an essential communication tool for large portions of the population. "
