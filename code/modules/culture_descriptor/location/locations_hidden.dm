/decl/cultural_info/homeculture/hidden
	description = "This is a hidden cultural detail. If you can see this, please report it on the tracker."
	hidden = TRUE
	hidden_from_codex = TRUE

/decl/cultural_info/homeculture/hidden/alium
	name = "Alien Humanoid"
	language = /decl/language/alium
	secondary_langs = null

/decl/cultural_info/homeculture/hidden/cultist
	name = "Blood Cultist"
	language = /decl/language/cultcommon

/decl/cultural_info/homeculture/hidden/cultist/get_random_name()
...
/decl/cultural_info/homeculture/hidden/monkey
	name = "Test Subject"
