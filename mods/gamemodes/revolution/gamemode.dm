/decl/game_mode/revolution
	...
	extended_round_description = "Revolutionaries - Remove the heads of staff from power. Convert other crewmembers to your cause using the 'Convert Bourgeoisie' verb. Protect your leaders."
	required_players = 4
	required_enemies = 3
