...
/mob/living/captive_brain/process_resist()
	...
	if(isborer(src.loc))
		...
		spawn(rand(200,250)+B.host.get_damage(BRAIN))
			...
			to_chat(B.host, "<span class='danger'>You feel control of the host brain ripped from your grasp, and retract your probosces before the wild neural impulses can damage you.</span>")
			B.detach_from_host()
