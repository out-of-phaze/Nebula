#define MAP_TEMPLATE_CATEGORY_SHIP "ship"
...
/decl/modpack/shiptesting
	...
	credits_topics =          list("SLIME GIRL TRAFFICKING", "SHIP TESTING")
	credits_nouns =           list("SHIPS", "TESTS", "THE SHIP", "THE TEST", "SHIPTESTER")
	credits_other =           list("BETTER TEST SHIPS", "SHIPPING TEST")